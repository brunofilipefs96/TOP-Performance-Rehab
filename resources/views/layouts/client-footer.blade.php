<footer class="text-center text-sm text-black dark:text-white dark:bg-gray-800 bg-gray-600">
    <div class="dark:text-gray-400 text-white  pt-10">
        <div class="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                ...
                <div class="flex justify-center items-center mb-4">
                    <a href="{{ route('faq.index') }}" class="hover:underline dark:hover:text-lime-400 hover:text-blue-500">Perguntas Frequentes</a>
                </div>
            </div>
            <div>
                <h3 class="text-xl text-center font-semibold mb-4">Horário de Funcionamento</h3>
        ...
        <div class="mt-8 pt-4">
            <div class="max-w-screen-xl mx-auto flex justify-center items-center dark:text-gray-400 text-white text-sm">
