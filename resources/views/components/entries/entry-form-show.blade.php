<div class="container mx-auto mt-10 pt-5 glass">
    <div class="flex justify-center">
        <div class="w-full max-w-4xl dark:bg-gray-800 p-4 px-5 rounded-2xl shadow-sm bg-gray-300 relative">
            ...
            <div class="card bg-gray-300 dark:bg-gray-800 p-4 rounded-2xl mt-4">
                ...
                @if(!$entry->survey->acceptsGuestEntries() && auth()->guest())
                    <div class="p-5">
                        Faça login para preencher o formulário.
                    </div>
                @else
                    <div id="sections-container">
                        @foreach($entry->survey->sections as $index => $section)
                            <div class="section p-4 dark:bg-gray-800 bg-gray-300 rounded-md my-4" data-section-index="{{ $index }}" style="{{ $index > 0 ? 'display:none;' : '' }}">
