...
{{--                <div style="min-height: 716px" class="w-60 gap-50 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">--}}
{{--                    <div class="px-8 ">--}}
{{--                        <div class="h-40 sm:w-full flex items-center mt-10 mb-4">--}}
{{--                            <div class=" mt-50 sm:w-ful flex flex-col items-center">--}}
{{--                                <img src="{{ asset('storage/' . $user->image) }}" alt class="h-28 w-28 bg-gray-200 border rounded-full"--}}
{{--                                />--}}
...
{{--                                    <span class="text-sm ml-2">Treinos</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="flex w-full justify-between text-gray-400 cursor-pointer items-center mb-6 dark:hover:text-lime-400 hover:text-blue-600">--}}
...
{{--                                        <path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1"></path>--}}
{{--                                    </svg>--}}
{{--                                    <span class="text-sm ml-2">agenda</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
...
{{--                    <button aria-label="toggle sidebar" id="openSideBar" class="h-10 w-10 bg-gray-800 absolute right-0 -mt-1 -mr-20 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800" onclick="sidebarHandler(true)">--}}
