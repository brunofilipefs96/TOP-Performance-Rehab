...
<div class="text-black/50 dark:text-white/50">
            ...
            @if (Route::has('login'))
                <nav class="flex space-x-4">
                    @auth
                        ...
                        <form method="POST" action="{{ route('logout') }}" onsubmit="disableConfirmButton(this)">
                            @csrf
    ...
    <main>
        <div class="text-center mt-10">
            <h1 class="text-4xl font-bold text-gray-800 dark:text-lime-400 mb-10">Sem Cargos</h1>
            <p class="text-lg text-gray-800 dark:text-gray-200">Você não possui cargos atribuídos. Por favor, contate um administrador para obter acesso.</p>
        </div>
    </main>
</div>
