        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center md:ms-6">
                ...
                <div x-show="notificationOpen">
                    <!-- Background Blur -->
                    <div class="fixed inset-0 z-40 bg-black bg-opacity-50" @click="notificationOpen = false"></div>
                        ...
                        <div class="bg-white dark:bg-gray-800 w-11/12 max-w-md mx-auto rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div class="px-4 py-2 border-t border-gray-200 dark:border-gray-700">
                                <a href="{{ route('notifications.index') }}"
                                   class="text-blue-600 dark:text-lime-400 hover:underline text-sm">Ver todas as notificações</a>
                            </div>
                        </div>
                    </div>
                </div>
