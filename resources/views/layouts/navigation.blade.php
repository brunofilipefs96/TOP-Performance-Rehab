                ...
                @if(Auth::check())
                    @if(Auth::user()->hasRole('admin'))
                        ...
                        <x-responsive-nav-link :href="route('rooms.index')" :active="request()->routeIs('rooms.index')"
                                               class="text-gray-500 dark:text-gray-200 hover:text-blue-400 dark:hover:text-lime-400 focus:text-blue-400 dark:focus:text-lime-400">
                            <i class="fa-solid fa-door-open text-lg mr-2"></i></i>{{ __('Salas') }}
                        </x-responsive-nav-link>
                    ...
                    @elseif(Auth::user()->hasRole('client'))
                        ...
                        <x-responsive-nav-link :href="route('trainings.index')" :active="request()->routeIs('trainings.index')"
                                               class="text-gra<!-- Theme Toggle Button and Notification Bell -->
<div class="flex justify-center mb-8 space-x-4">
                        ...
                        <button id="theme-toggle-client" type="button"
                                class="theme-toggle-btn text-gray-800 dark:text-gray-400 hover:text-gray-400 dark:hover:text-yellow-400 rounded-lg text-sm p-2.5">
            ...
            </div>y-500 dark:text-gray-200 hover:text-blue-400 dark:hover:text-lime-400 focus:text-blue-400 dark:focus:text-lime-400">
                            <i class="fa-solid fa-dumbbell text-lg mr-2"></i>{{ __('Treinos') }}
                        </x-responsive-nav-link>
