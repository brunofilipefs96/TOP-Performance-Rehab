<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center select-none">
        <div class="max-w-4xl w-full bg-white dark:bg-black shadow-lg rounded-lg p-8">
            ...
            <h2 class="text-4xl font-bold text-lime-300 text-center mb-1  p-2">Crie a sua conta</h2>
            <h2 class="text-xl text-white text-center mb-6">Preencha os seus dados</h2>
            <hr>
